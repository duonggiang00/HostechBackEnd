...
const DetailStaff = () => {
  ...
  useEffect(() => {
    // TODO: gọi API để lấy chi tiết nhân viên theo id
  ...
  const handleToggleLock = async () => {
    setLoading(true);
    try {
      // TODO: gọi API để khoá/mở khoá nhân viên
      if (isLocked) {
        message.success("Mở khoá nhân viên thành công");
      } else {
        message.success("Khoá nhân viên thành công");
      }
