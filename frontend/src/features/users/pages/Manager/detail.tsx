...
const DetailManager = () => {
  ...
  useEffect(() => {
    // TODO: gọi API để lấy chi tiết quản lý theo id
    const mockData: ManagerDetail = {
  ...
  const handleToggleLock = async () => {
    setLoading(true);
    try {
      // TODO: gọi API để khoá/mở khoá quản lý
      if (isLocked) {
        message.success("Mở khoá quản lý thành công");
      } else {
        message.success("Khoá quản lý thành công");
      }
    ...
    <div className="flex flex-col gap-6 p-5 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Chi tiết quản lý</h1>
        </div>
