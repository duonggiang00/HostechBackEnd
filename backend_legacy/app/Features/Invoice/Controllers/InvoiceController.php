...
namespace App\Features\Invoice\Controllers;

use App\Enums\InvoiceItemType;
use App\Features\Finance\Services\PaymentService;
use App\Features\Invoice\Services\InvoiceService;
use App\Features\Invoice\Services\RecurringBillingService;
use App\Http\Controllers\Controller;
use App\Features\Invoice\Requests\InvoiceIndexRequest;
use App\Features\Invoice\Requests\InvoiceStoreRequest;
use App\Features\Invoice\Requests\InvoiceUpdateRequest;
use App\Features\Invoice\Resources\InvoiceItemResource;
use App\Features\Invoice\Resources\InvoiceResource;
...
class InvoiceController extends Controller
{
     ...
     */
    public function generateMonthlyForProperty(Request $request, string $property_id, InvoiceService $invoiceService): JsonResponse
    {
        $this->authorize('create', Invoice::class);

        $property = \App\Features\Property\Models\Property::findOrFail($property_id);
