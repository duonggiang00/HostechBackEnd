...
use App\Features\Property\Requests\RoomTemplateStoreRequest;
use App\Features\Property\Requests\RoomTemplateUpdateRequest;
use App\Features\Property\Resources\RoomTemplateResource;
        ...
        return DB::transaction(function () use ($request) {
            ...
            if ($request->has('meters')) {
                foreach ($request->meters as $meterData) {
                    $template->meters()->create([
                        'type' => $meterData['type'],
                        'service_id' => $meterData['service_id']
                    ]);
                }
            }
