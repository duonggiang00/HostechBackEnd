...
namespace App\Features\Service\Services;

use App\Features\Service\Models\RoomService as RoomServiceModel;
use App\Features\Service\Models\Service;
use App\Features\Service\Models\ServiceRate;
use App\Features\Service\Models\TieredRate;
...
{
    public function paginate(array $allowedFilters = [], int $perPage = 15, ?string $search = null, ?string $orgId = null, ?string $propertyId = null): LengthAwarePaginator
    {
    ...
    public function paginateTrash(array $allowedFilters = [], int $perPage = 15, ?string $search = null, ?string $orgId = null, ?string $propertyId = null): LengthAwarePaginator
    {
