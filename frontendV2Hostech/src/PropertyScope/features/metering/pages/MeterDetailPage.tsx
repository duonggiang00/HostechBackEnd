...
import { ArrowLeft, Loader2, Plus, Check, X, Clock, Trash2 } from 'lucide-react';
...
export default function MeterDetailPage() {
  ...
  if (!meter) {
    return (
      <div className="p-6">
        <p className="text-red-600">Không tìm thấy đồng hồ</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <h1 className="text-3xl font-bold text-slate-900">Chi tiết đồng hồ</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-slate-900">{meter.code}</p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <div className={`w-3 h-3 rounded-full ${meter.is_active ? 'bg-green-500' : 'bg-slate-300'}`} />
            ...
            <div>
              ...
              {meter.room ? (
                <div>
                  <p className="text-lg font-semibold text-slate-900">{meter.room.code}</p>
                  <p className="text-sm text-slate-600">{meter.room.name}</p>
                </div>
              ) : (
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-slate-900">Lịch sử chốt số</h2>
            <button
          ...
          {/* Add Reading Form */}
          {showAddForm && (
            <form onSubmit={handleAddReading} className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">Thêm chốt số mới</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-slate-900 mb-2">
                    Chỉ số <span className="text-red-600">*</span>
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className="w-full px-4 py-2.5 border border-slate-200 rounded-lg bg-slate-100 cursor-not-allowed text-slate-600"
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  ...
                  className="px-6 py-2.5 border border-slate-200 text-slate-900 font-semibold rounded-lg hover:bg-slate-50 transition-colors"
                >
                  Hủy
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            {readingsLoading ? (
              ...
              <div className="p-12 text-center">
                <p className="text-slate-600">Chưa có lịch sử chốt số</p>
              </div>
            ) : (
              <>
                  ...
                  <table className="w-full">
                    <thead className="bg-slate-50 border-b border-slate-200">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-left text-sm font-semibold text-slate-700">Chỉ số</th>
                            ...
                            <div className="flex items-center gap-2">
                              {reading.status === 'APPROVED' && (
                                <>
                                  ...
                                  <span className="text-sm font-semibold text-green-600">Đã duyệt</span>
                                </>
                              )}
                              {reading.status === 'PENDING' && (
                                <>
                                  <Clock className="w-4 h-4 text-yellow-600" />
                                  <span className="text-sm font-semibold text-yellow-600">Chờ duyệt</span>
                                </>
                              )}
          ...
          {showEditForm && editingReading && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-2xl shadow-lg max-w-lg w-full max-h-96 overflow-y-auto">
                <div className="sticky top-0 border-b border-slate-200 px-6 py-4 bg-white flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-slate-900">Sửa chốt số</h3>
                  <button
                    onClick={() => {
                      setShowEditForm(false);
                      setEditingReading(null);
                ...
                <form onSubmit={handleUpdateReading} className="p-6 space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 border border-slate-200 text-slate-900 font-semibold rounded-lg hover:bg-slate-50 transition-colors flex-1"
                    >
                      Hủy
                    </button>
                  </div>
