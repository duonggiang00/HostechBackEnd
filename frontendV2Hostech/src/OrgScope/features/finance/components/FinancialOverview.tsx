    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                 ...
                 <div key={i} className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5 hover:border-white/10 transition-all">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Tenant A0{i}</p>
                       </div>
                    </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8">
            ...
            <div className="flex justify-between mt-4 px-4 text-[10px] font-black text-slate-600 uppercase tracking-widest">
               <span>Mon</span>
               <span>Wed</span>
               <span>Fri</span>
               <span>Sun</span>
