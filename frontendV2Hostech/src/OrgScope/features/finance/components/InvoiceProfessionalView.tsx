      ...
      <div className="flex-1">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-100">
            {[
              { desc: 'Monthly Rental Payment', qty: 1, price: 1200, total: 1200 },
              { desc: 'Water & Utility Surcharge', qty: 1, price: 45, total: 45 },
              { desc: 'Maintenance Service (Monthly)', qty: 1, price: 15, total: 15 },
            ].map((item, i) => (
              <tr key={i}>
      ...
      <div className="mt-12 pt-8 border-t-2 border-slate-900 flex justify-between items-end">
        <div className="flex gap-4">
          <button className="flex flex-col items-center gap-2 p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-slate-900 transition-all">
             ...
             <span className="text-[8px] font-black uppercase tracking-widest text-slate-400 group-hover:text-indigo-400">Print</span>
          </button>
          <button className="flex flex-col items-center gap-2 p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-slate-900 transition-all">
             <Download className="w-4 h-4 text-slate-400 group-hover:text-white" />
             <span className="text-[8px] font-black uppercase tracking-widest text-slate-400 group-hover:text-indigo-400">Save</span>
          </button>
          <button className="flex flex-col items-center gap-2 p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-slate-900 transition-all">
             <Share2 className="w-4 h-4 text-slate-400 group-hover:text-white" />
             <span className="text-[8px] font-black uppercase tracking-widest text-slate-400 group-hover:text-indigo-400">Share</span>
          </button>
        </div>
        <div className="text-right">
          ...
          <div className="flex items-center gap-8">
            <span className="text-xs font-black uppercase italic tracking-[0.2em] text-slate-400 underline decoration-slate-200 underline-offset-8">Total Amount Due</span>
