          ...
          <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Chi tiết bảng kê hóa đơn</p>
              </div>
            </div>
            <button
              onClick={onClose}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="bg-slate-50 rounded-4xl p-6 border border-slate-100">
                    <h3 className="text-xs font-black uppercase text-slate-400 tracking-[0.2em] mb-6">Các khoản thanh toán</h3>
                    <table className="w-full">
                      <thead>
                        <tr className="text-left">
                          <th className="pb-4 text-xs font-black text-slate-400 uppercase">Mô tả</th>
                          <th className="pb-4 text-xs font-black text-slate-400 uppercase text-center">SL</th>
                          <th className="pb-4 text-xs font-black text-slate-400 uppercase text-right">Thành tiền</th>
                        </tr>
                      </thead>
                ...
                <div className="space-y-6">
                  <div className="p-8 bg-slate-900 rounded-4xl text-white shadow-2xl relative overflow-hidden">
                    ...
                    <h3 className="text-xs font-black uppercase text-indigo-400 tracking-[0.2em] mb-8">Tóm tắt Tài chính</h3>
                  ...
                  <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="text-xs font-black uppercase text-slate-400 tracking-widest">Hoạt động gần đây</h3>
                    </div>
                    <div className="space-y-4">
