...
- **Scramble Docs**: Mọi `IndexRequest` PHẢI có class-level DocBlock chứa đầy đủ `@queryParam` cho: `per_page`, `page`, `search`, `with_trashed`, `sort`, và tất cả các `filter[...]` được hỗ trợ.
