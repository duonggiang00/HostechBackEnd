 ...
 * Dòng tiền được tổng hợp từ LedgerEntry: chỉ các dòng ảnh hưởng quỹ (CASH_BANK trên payment/reversal) và bút toán `cashflow_manual` — không cộng dồn bút kép trên A/R.
 */
...
class CashflowController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        // Dòng tiền: debit = vào quỹ, credit = ra quỹ (đã loại bút kép A/R; gồm thu/chi thủ công cashflow_manual).
        ...
        $dailyQuery = LedgerEntry::withoutGlobalScope('org_id')
            ->where('org_id', $orgId)
            ->forCashflowReport()
            ->selectRaw('
