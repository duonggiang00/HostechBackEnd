...
class Room extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany(\App\Features\Meter\Models\Meter::class);
    }

    public function services()
    {
        return $this->belongsToMany(\App\Features\Service\Models\Service::class, 'room_services');
    }

    public function invoices()
    {
        return $this->hasMany(\App\Features\Invoice\Models\Invoice::class);
    }

    public function activeContract()
    {
        return $this->hasOne(\App\Features\Contract\Models\Contract::class)
            ->where('status', 'ACTIVE')
            ->latestOfMany();
    }
}
